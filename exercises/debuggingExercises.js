// Word Ladder
// Need a semicolon after the ladder assignment statement to avoid issues with automatic semicolon insertion
// let ladder = '';
...
function neutralize(sentence) {
  ...
  let neutralizedWords = [];

  words.forEach(word => {
    if (!isNegative(word)) {
      neutralizedWords.push(word);
    }
  });
  return neutralizedWords.join(" ");
};
